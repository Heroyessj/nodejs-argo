...
const PORT = process.env.SERVER_PORT || process.env.PORT || 10070;        // http服务订阅端口
const UUID = process.env.UUID || '8816f000-1825-461e-a3bf-9a735f024c97'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'gamevps.bjgh.nyc.mn';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYWI4OTE5ZTI4MTA4ZDBjOTRiZDlmY2Y3MDg2NzViY2MiLCJ0IjoiZjUyNWEyZDEtZWMzMi00Y2JiLWJlYjMtOTkxMWQ3YjY2YmU5IiwicyI6Ik1XTTBNek5pTWpndE1XVmxZaTAwT1RZNUxXSTROak10TnpJMlkyTXdaR1JoWkdObSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
const ARGO_PORT = process.env.ARGO_PORT || 8001;            // 固定隧道端口,使用token需在cloudflare后台设置和这里一致
const CFIP = process.env.CFIP || 'cdns.doon.eu.org';        // 节点优选域名或优选ip  
const CFPORT = process.env.CFPORT || 443;                 // 节点优选域名或优选ip对应的端口
const NAME = process.env.NAME || 'BerryHost-GB';                 // 节点名称
